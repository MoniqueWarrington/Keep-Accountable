    ...
    render(){
        return(
            <nav class="navbar navbar-expand-lg navbar-dark bg-custom">
                <h1 class="nav-title" style = {navTitle}>Keep-Accountable</h1>
                ...
                <div class="collapse navbar-collapse" id="navbarColor01">
                    <div class ="center">
                        ...
                        <li class="nav-item space-apart">
                            <a class="nav-link" href="challenge"><h2>Goals</h2></a>
                        </li>
                        <li class="nav-item space-apart">
                    ...
                    <button class="btn btn-secondary my-2 my-sm-0 round-obj" style={rounded} type="submit">Search</button>
                    </form>
                </div>
            </nav>
        );
